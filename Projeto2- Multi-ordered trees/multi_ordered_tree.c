...
//
// tree_node_t new_tree_node_t(char name, char zip_code, char telephone_number){
...
//   // tree_node_t alberto = {.name={name}, .zip_code={zip_code}, .telephone_number={telephone_number}};
//   // return alberto;
// };
